...
int main() {
    ...
    int i;
    int t;
    long long int wind; //long long int is for long long int as in the name
...
fflush(stdout); {printf("danger level %d\n", danger);}
    sleep(3);
        ...
        while(danger < 3) {
            ...
            else if (response == 'f')
            {
                ...
                scanf(" %d", &flash);
                if (flash == 1 && i != 2) //flash hallway and no BB
                {
                    ...
                    else if (i == 0 && response == 'f') {danger--; goto foxy_clear;}
                    else {danger++;}
                }
                else if (flash == 2 && i == 2)//flash BB in vent
                {
                    ...
                    ) {printf("*click click* uh oh looks like the flashlight isnt working\n"); sleep(1);goto gameover;}
            ...
            else mask:
            {
                printf("mask is on\n");
                    ...
                    if (i !=0) {
                        danger--;
                        if (i==2) {printf("'thump! thump! thump'\n");sleep(1);}
                        else foxy_clear:{printf("hallway is clear"); sleep(1);}
                    }

                    else {
                        danger++;
                        if (danger ==3 ){printf("phew hallway is clear");}
